...
function WorkoutCard({ workout }: WorkoutCardProps) {
    ...
    return (
        ...
        >
            <div
                className={cn(
                    'border-border w-full rounded-lg p-4 text-start shadow-sm',
                    workout.status === WorkoutStatus.DRAFTED
                        ? 'bg-muted border-2 text-muted-foreground border-dashed'
...
function EmptyWorkouts() {
    return (
        <div className="bg-muted text-muted-foreground flex flex-col items-center space-y-2 rounded-md p-8">
    ...
    return (
        <div className="flex animate-pulse flex-col space-y-4">
            {Array.from({ length: 3 }).map((_, i) => (
                <div
                    key={`shimmer-div-${i}`}
                    className="bg-muted rounded-lg px-5 py-4"
                >
                    <div className="flex flex-col space-y-2">
                        <div className="mb-2 flex flex-col gap-y-1">
                            <div className="bg-secondary h-4 w-40 rounded-md"></div>
                            <div className="bg-secondary h-3 w-20 rounded-md"></div>
                        </div>

                        <div className="bg-secondary h-3 w-52 rounded-md"></div>
                        <div className="bg-secondary h-3 w-52 rounded-md"></div>
                        <div className="bg-secondary h-3 w-52 rounded-md"></div>
                        <div className="bg-secondary h-3 w-52 rounded-md"></div>
                        <div className="bg-secondary h-3 w-52 rounded-md"></div>
